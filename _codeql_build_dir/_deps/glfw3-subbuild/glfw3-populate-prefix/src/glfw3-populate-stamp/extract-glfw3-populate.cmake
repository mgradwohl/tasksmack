...
#
get_filename_component(filename "/home/runner/work/tasksmack/tasksmack/_codeql_build_dir/_deps/glfw3-subbuild/glfw3-populate-prefix/src/glfw-3.4.zip" ABSOLUTE)
get_filename_component(directory "/home/runner/work/tasksmack/tasksmack/_codeql_build_dir/_deps/glfw3-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-glfw3-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-glfw3-populate${i}")
