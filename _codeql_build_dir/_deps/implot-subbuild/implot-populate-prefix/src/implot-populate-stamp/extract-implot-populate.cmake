...
#
get_filename_component(filename "/home/runner/work/tasksmack/tasksmack/_codeql_build_dir/_deps/implot-subbuild/implot-populate-prefix/src/master.zip" ABSOLUTE)
get_filename_component(directory "/home/runner/work/tasksmack/tasksmack/_codeql_build_dir/_deps/implot-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-implot-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-implot-populate${i}")
