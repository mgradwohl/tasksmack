...
#
get_filename_component(filename "/home/runner/work/tasksmack/tasksmack/_codeql_build_dir/_deps/glad-subbuild/glad-populate-prefix/src/v2.0.8.zip" ABSOLUTE)
get_filename_component(directory "/home/runner/work/tasksmack/tasksmack/_codeql_build_dir/_deps/glad-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-glad-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-glad-populate${i}")
