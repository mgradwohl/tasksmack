...
| **Google Benchmark suite** | `benchmarks/` – History, ProcessModel, SystemModel, Format, NetlinkSocketStats benchmarks with memory-growth tracking via `/proc/self/status`; `benchmark` and `win-benchmark` CMake presets |
