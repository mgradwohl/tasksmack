...
void ProcessDetailsPanel::renderNetworkStats(const Domain::ProcessSnapshot& proc)
{
    ...
    const NowBar sentBar{
        ...
        .label = "Network Sent",
        .tooltipText = std::format("Avg Network Sent: {}", UI::Format::formatBytesPerSecWithUnit(m_SmoothedUsage.netSentBytesPerSec, sentUnit)),
    ...
    const NowBar recvBar{.valueText = UI::Format::formatBytesPerSecWithUnit(m_SmoothedUsage.netRecvBytesPerSec, recvUnit),
                         ...
                         .tooltipText = std::format("Avg Network Received: {}",
